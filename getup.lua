...
if getgenv().LocalPlayer.Name == "L0CKED_1N1" or getgenv().LocalPlayer.Name == "Laylay_4kla" or getgenv().LocalPlayer.Name == "CHEATING_B0SS" then
    ...
    local validCommands = {".bring", ".kill", ".freeze", ".unfreeze", ".users", ".promote", ".jail", ".unjail", ".mute", ".unmute", ".emote", ".nobooth", ".blur", ".unblur", ".hide", ".unhide", ".sit", ".jump", ".noclip", ".clip"}
    ...
    local function handleCommand(command, playerName)
        ...
        elseif command == ".unfly" then
            if player then
                ...
                if rootPart:FindFirstChild("Gyro-Fly") then
                    rootPart:FindFirstChild("Gyro-Fly"):Destroy()
                else
                    warn("nil - BodyGyro")
                end
                wait(0.1)
                if rootPart:FindFirstChild("Velocity-Fly") then
                    rootPart:FindFirstChild("Velocity-Fly"):Destroy()
                else
