...
if getgenv().LocalPlayer.Name == "L0CKED_1N1" or getgenv().LocalPlayer.Name == "Laylay_4kla" or getgenv().LocalPlayer.Name == "CHEATING_B0SS" then
    ...
    local validCommands = {".bring", ".kill", ".freeze", ".unfreeze", ".users", ".promote", ".jail", ".unjail", ".mute", ".unmute", ".emote", ".nobooth", ".blur all", ".unblur all", ".hide", ".unhide"}
    ...
    getgenv().TextChatService.MessageReceived:Connect(function(message) 
        ...
        if sender == "L0CKED_1N1" or sender == "Laylay_4kla" then
            local prefix, command, playerName = string.match(text, "^(%.)([%w%s]+)%s*(.*)")
